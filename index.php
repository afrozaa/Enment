    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <!--li>
            <a href="#" class="navbar-link">Music</a>
          </li-->
      ...
      <section class="hero">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle">Enment</p>
...
<!-- 
      ...
      <section class="cta">
        <div class="container">
          ...
          <div class="title-wrapper">
            <h2 class="cta-title">Take your membership now!</h2>
          ...
          <form action="" class="cta-form">
            ...
            <a href="transaction.php" class="cta-form-btn">Get Started</a>
          </form>
